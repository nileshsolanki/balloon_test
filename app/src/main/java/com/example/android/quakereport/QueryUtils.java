...
//
    ...
    public static List<EarthQuake> fetchEarthQuakeData(String reqUrl) {
        ...
        try {
            ...
            Log.e(LOG_TAG,"jsonResponse send was null",e);
        }
    ...
    private static String makeHTTPRequest(URL url) throws IOException {
        ...
        try {
            ...
            if (httpURLConnection.getResponseCode() == 200) {
                ...
                Log.e(LOG_TAG, "The response code return by Server is other than 200");
            }
        } catch (IOException e) {
            Log.e(LOG_TAG, "Problem retrieving Earthquake JsonResponse", e);
        } finally {
